# Gqlforge for Nodejs and Browser
...
```shell
npm i @gqlforge/gqlforge-wasm
```

## Local setup

Go to gqlforge-wasm dir
...
Run simple http server in `gqlforge-wasm` dir:
...
sample playground: [link](http://0.0.0.0:8000/example/browser/?config=https://raw.githubusercontent.com/takumi3488/gqlforge/main/examples/jsonplaceholder.graphql)
...
<html lang="en-US">
  ...
  <body>
    ...
    <script type="module">
      import init, {GqlforgeBuilder} from "../../browser/pkg/gqlforge_wasm.js"
      await init()
      ...
      async function setup() {
        try {
          ...
          let builder = new GqlforgeBuilder()
