...
describe("fetch", () => {
  test("loadfiles", async () => {
    ...
    let news_proto = (await readFile("../gqlforge-fixtures/fixtures/protobuf/news.proto")).toString()
    let news_dto_proto = (await readFile("../gqlforge-fixtures/fixtures/protobuf/news_dto.proto")).toString()

    let bucket = await mf.getR2Bucket("MY_R2")
    await bucket.put("examples/grpc.graphql", grpc)
    await bucket.put("examples/../gqlforge-fixtures/fixtures/protobuf/news.proto", news_proto)
    await bucket.put("examples/../gqlforge-fixtures/fixtures/protobuf/news_dto.proto", news_dto_proto)
    await bucket.put("gqlforge-fixtures/fixtures/protobuf/news.proto", grpc)
